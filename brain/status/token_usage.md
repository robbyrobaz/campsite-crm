# Token Usage
**Updated:** 2026-04-01 03:30 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **3.0%** | Apr 01 08:00 AM MST |
| 7-day (all) | **87.0%** 🔴 | Apr 02 09:00 PM MST |
| 7-day (Sonnet) | **75.0%** | Apr 03 08:00 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 8.7M (55 requests)
- **Input:** 110 | **Output:** 8.3K
- **Cache Read:** 7.1M | **Cache Write:** 1.6M
- **Cost (est):** $8.13

### By Model (5h)
| Model | Requests | Tokens | Output | Cost |
|-------|----------|--------|--------|------|
| sonnet | 55 | 8.7M | 8.3K | $8.13 |

## Rolling 24-Hour Window
- **Total Tokens:** 27.5M (264 requests)
- **Output Tokens:** 57.5K
- **Cost (est):** $28.57
