# Token Usage
**Updated:** 2026-03-18 10:45 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **8.0%** | Mar 18 02:00 PM MST |
| 7-day (all) | **93.0%** 🔴 | Mar 19 09:00 PM MST |
| 7-day (Sonnet) | **96.0%** | Mar 19 09:00 PM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 1.4M (39 requests)
- **Input:** 1.4M | **Output:** 8.6K
...
|-------|----------|--------|--------|------|
| nvidia/nemotron-3-super-120b-a12b | 39 | 1.4M | 8.6K | $0.00 |
