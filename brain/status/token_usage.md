# Token Usage
**Updated:** 2026-04-03 01:30 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **24.0%** | Apr 03 02:00 AM MST |
| 7-day (all) | **4.0%** | Apr 09 09:00 PM MST |
| 7-day (Sonnet) | **97.0%** | Apr 03 08:00 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 0 (1624 requests)
- **Input:** 0 | **Output:** 0
...
|-------|----------|--------|--------|------|
| x-ai/grok-4-fast | 1624 | 0 | 0 | $0.00 |

## Rolling 24-Hour Window
- **Total Tokens:** 34.7M (5424 requests)
- **Output Tokens:** 85.3K
- **Cost (est):** $27.88
...
| sonnet | 1538 | 0 | 0 | $0.00 |
| x-ai/grok-4.1-fast | 8 | 0 | 0 | $0.00 |
| x-ai/grok-4-fast | 3642 | 0 | 0 | $0.00 |
