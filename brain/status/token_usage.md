# Token Usage
**Updated:** 2026-04-11 07:15 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **18.0%** | Apr 11 10:00 AM MST |
| 7-day (all) | **16.0%** | Apr 16 10:00 PM MST |
| 7-day (Sonnet) | **18.0%** | Apr 17 08:00 AM MST |
...
- **Total Tokens:** 42.2K (31 requests)
- **Output Tokens:** 76
- **Cost (est):** $0.00
