# Token Usage
**Updated:** 2026-03-31 17:45 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **3.0%** | Mar 31 10:00 PM MST |
| 7-day (all) | **82.0%** ⚠️ | Apr 02 09:00 PM MST |
| 7-day (Sonnet) | **67.0%** | Apr 03 08:00 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 3.4M (27 requests)
- **Input:** 113 | **Output:** 4.0K
- **Cache Read:** 2.7M | **Cache Write:** 753.6K
- **Cost (est):** $3.69

### By Model (5h)
| Model | Requests | Tokens | Output | Cost |
|-------|----------|--------|--------|------|
| sonnet | 27 | 3.4M | 4.0K | $3.69 |

## Rolling 24-Hour Window
- **Total Tokens:** 14.2M (183 requests)
- **Output Tokens:** 44.8K
- **Cost (est):** $16.27
