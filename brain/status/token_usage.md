# Token Usage
**Updated:** 2026-04-11 06:30 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **13.0%** | Apr 11 10:00 AM MST |
| 7-day (all) | **15.0%** | Apr 16 10:00 PM MST |
| 7-day (Sonnet) | **17.0%** | Apr 17 08:00 AM MST |
...
- **Total Tokens:** 42.2K (30 requests)
- **Output Tokens:** 76
- **Cost (est):** $0.00
