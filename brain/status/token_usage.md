...
- **Total Tokens:** 444.5K (6 requests)
- **Input:** 10 | **Output:** 1.7K
- **Cache Read:** 292.5K | **Cache Write:** 150.3K
- **Cost (est):** $1.13

### By Model (5h)
| Model | Requests | Tokens | Output | Cost |
|-------|----------|--------|--------|------|
| opus | 6 | 444.5K | 1.7K | $1.13 |

## Rolling 24-Hour Window
- **Total Tokens:** 15.0M (188 requests)
- **Output Tokens:** 55.9K
- **Cost (est):** $11.12
