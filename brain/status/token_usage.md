# Token Usage
**Updated:** 2026-03-31 15:15 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **12.0%** | Mar 31 05:00 PM MST |
| 7-day (all) | **81.0%** ⚠️ | Apr 02 09:00 PM MST |
| 7-day (Sonnet) | **65.0%** | Apr 03 08:00 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 4.8M (56 requests)
- **Input:** 522.7K | **Output:** 23.4K
- **Cache Read:** 2.9M | **Cache Write:** 1.4M
- **Cost (est):** $6.09

### By Model (5h)
| Model | Requests | Tokens | Output | Cost |
|-------|----------|--------|--------|------|
| sonnet | 38 | 4.2M | 9.0K | $6.09 |
