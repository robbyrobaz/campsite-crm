# Token Usage
**Updated:** 2026-04-04 06:45 MST

## ⚡ Anthropic Rate Limits (Cached — 60min ago)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **8.0%** | Apr 04 10:00 AM MST |
| 7-day (all) | **21.0%** | Apr 09 09:00 PM MST |
| 7-day (Sonnet) | **26.0%** | Apr 10 08:00 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 0 (0 requests)
- **Input:** 0 | **Output:** 0
...
- **Total Tokens:** 4.5M (3126 requests)
- **Output Tokens:** 9.3K
- **Cost (est):** $2.87
...
| x-ai/grok-4-fast | 3041 | 0 | 0 | $0.00 |
