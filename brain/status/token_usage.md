# Token Usage
**Updated:** 2026-04-02 14:30 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **0.0%** | ? |
| 7-day (all) | **100.0%** 🔴 | Apr 02 08:59 PM MST |
| 7-day (Sonnet) | **92.0%** | Apr 03 07:59 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 0 (1009 requests)
- **Input:** 0 | **Output:** 0
...
| x-ai/grok-4-fast | 1007 | 0 | 0 | $0.00 |

## Rolling 24-Hour Window
- **Total Tokens:** 41.2M (4530 requests)
- **Output Tokens:** 88.0K
- **Cost (est):** $35.05
