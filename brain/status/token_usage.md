# Token Usage
**Updated:** 2026-03-31 14:45 MST

## ⚡ Anthropic Rate Limits (Live)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **10.0%** | Mar 31 05:00 PM MST |
| 7-day (all) | **81.0%** ⚠️ | Apr 02 09:00 PM MST |
| 7-day (Sonnet) | **65.0%** | Apr 03 08:00 AM MST |

## Rolling 5-Hour Window
- **Total Tokens:** 5.9M (91 requests)
- **Input:** 522.8K | **Output:** 30.3K
...
- **Total Tokens:** 12.8M (184 requests)
- **Output Tokens:** 45.6K
- **Cost (est):** $14.58
