# Token Usage
**Updated:** 2026-04-04 05:00 MST

## ⚡ Anthropic Rate Limits (Cached — 45min ago)
| Window | Usage | Resets At |
|--------|-------|-----------|
| 5-hour | **7.0%** | Apr 04 05:00 AM MST |
| 7-day (all) | **19.0%** | Apr 09 09:00 PM MST |
| 7-day (Sonnet) | **23.0%** | Apr 10 08:00 AM MST |
...
- **Total Tokens:** 4.5M (3772 requests)
- **Output Tokens:** 9.3K
- **Cost (est):** $2.87
...
| x-ai/grok-4-fast | 3687 | 0 | 0 | $0.00 |
