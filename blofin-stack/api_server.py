...
def fetch_summary():
    ...
    ticks = [dict(r) for r in con.execute(f'SELECT ts_iso,symbol,price,source FROM ticks {wh} ORDER BY ts_ms DESC LIMIT 6000', args)]
...
<body><div class='wrap'>
<div class='h'><h1>Blofin 24/7 Pattern Dashboard</h1><div class='small'>small-cap movers · confirm · paper trade · gap-fill</div></div>
<div class='grid'>
