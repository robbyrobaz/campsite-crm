...
## ARB DASHBOARD BUILDER (10:24 MST)

**Status:** Sonnet subagent spawned to wire real odds API into React dashboard
- Label: `arb-dashboard-odds-wiring`
- Task: Replace manual odds entry with auto-fetched odds from The Odds API
- API key already in `.env`: `VITE_ODDS_API_KEY=d1d65876901fd302c881472e0d70da2c`
- New flow: user selects books + enters promos (amount/type only) → engine auto-finds best hedges across all games
- Haven't checked on builder output yet
